        ...
        rapportScoreTA.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if( e.getKeyCode() == KeyEvent.VK_ENTER) {
                    DMmain.calculateRapScore(rapportScoreTA.getText());
                }
            }
        });
...
//        nonVerbalPanel.add(smileCheck, gbc);
        ...
        if( DMmain.userConvStrategy == null || DMmain.userConvStrategy.isEmpty() ) {
            DMmain.userConvStrategy = (String) ucsComboBox.getSelectedItem();
        }
...
//        nonVerbalPanel.add(ucsTextArea, gbc)
        ...
        delay.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode() == KeyEvent.VK_ENTER) {
                    e.consume();
                    DMmain.delayMainLoop = Long.valueOf(delay.getText());
                }
            }
...
//                    pressBackSpace();
    ...
    private void processInput(String text) {
        ...
        String[] result = controller.extractNonVerbal( DMmain.behavior );
