...
public class OutputEmulator extends JPanel{
    ...
    public void printStates(String state){
        states.setText(state + "\n\nSent to NLG. CS: " + Arrays.toString(DMmain.conversationalStrategies) + "  Phase: " +
                DMmain.inputController.phase + "  Intention: " + DMmain.behavior);
    }

    public void printStates(String state, String phase, String intention){
        String prefix = (++cont) + ". ";
        statesOutput += prefix + "Sent to NLG --> Conversational Strategy: " +Arrays.toString(DMmain.conversationalStrategies) + ",  Phase: " +
