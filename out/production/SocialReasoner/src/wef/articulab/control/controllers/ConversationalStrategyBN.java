...
public class ConversationalStrategyBN extends BehaviorNetworkController implements BlackboardListener {
    ...
    public BehaviorNetworkPlus createBN() {
        ...
        if( load ){
            network = Utils.fromJson("SocialReasonerBN.json", BehaviorNetworkPlus.class);
            ...
            behavior.addPreconditions(new String[][]{new String[]{Constants.ASN_HISTORY, Constants.PR_HISTORY, Constants.VSN_HISTORY}});
            behavior.addAddList(Arrays.asList(Constants.SD_SYSTEM));
            ...
            behavior.addAddList(Arrays.asList(Constants.VSN_SYSTEM));
            modules.add(behavior);
            ...
            behavior.addPreconditions(new String[][]{new String[]{Constants.SD_HISTORY, Constants.QESD_HISTORY, Constants.PR_HISTORY}});
            behavior.addAddList(Arrays.asList(Constants.QESD_SYSTEM));
            modules.add(behavior);
            ...
            behavior.addAddList(Arrays.asList(Constants.RSE_SYSTEM));
            modules.add(behavior);
            ...
            behavior.addPreconditions(new String[][]{new String[]{Constants.SD_HISTORY, Constants.QESD_HISTORY}});
            behavior.addAddList(Arrays.asList(Constants.PR_SYSTEM));
            modules.add(behavior);
            ...
            behavior.addAddList(Arrays.asList(Constants.ASN_SYSTEM));
            modules.add(behavior);


            // Back-Channel
            behavior = new BehaviorPlus("BC");
            behavior.setDescription(Constants.BACK_CHANNEL);
            behavior.addPreconditions(new String[][]{new String[]{Constants.HIGH_JITTER, Constants.HIGH_SHIMMER}});
            //        behavior.addPreconditions(new String[][]{ new String[]{Constants.NOT_BC_HISTORY}});
            behavior.addAddList(Arrays.asList(Constants.BC_SYSTEM));
            modules.add(behavior);
            ...
            goals.add(Constants.INCREASE_RAPPORT);
    ...
    public String removeState(String state) {
        String remove = null;
        if( state.equals(Constants.SD_SYSTEM) ){
            remove = Constants.ASN_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.ASN_SYSTEM) ){
            remove = Constants.SD_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.VSN_SYSTEM) ){
            remove = Constants.ASN_SYSTEM + ":" + Constants.SD_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.QESD_SYSTEM) ){
            remove = Constants.ASN_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.SD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.RSE_SYSTEM) ){
            remove = Constants.ASN_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.SD_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.BC_SYSTEM) ){
            remove = Constants.ASN_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.SD_SYSTEM + ":" + Constants.PR_SYSTEM;
        }else if( state.equals(Constants.PR_SYSTEM) ) {
            remove = Constants.ASN_SYSTEM + ":" + Constants.VSN_SYSTEM + ":" + Constants.QESD_SYSTEM + ":" +
                    Constants.RSE_SYSTEM + ":" + Constants.BC_SYSTEM + ":" + Constants.SD_SYSTEM;
